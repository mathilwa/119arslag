...
export const jubilantene = [
  {
    ...
    jubilant: JUBILANT_TROND,
    tittel: 'Lederhosen',
    tekst: 'Etter å ha vært på militærkurs i Tyskland hadde Arnulf Odd med seg gave hjem til Trond, en «lederhosen», som var en lærshorts med skulderremmer og frontstykke. ' +
    ...
    jubilant: JUBILANT_TORUNN,
    tittel: 'Leikarring',
    tekst: 'Torunn likte godt å danse, og gikk på gammeldanskurs og leikarring. Torunn var ikke på mange bygdedanser, men dansa når det var mulighet. ' +
    ...
    'Dette valget ble rett og slett tatt på bakgrunn av det gode elektronikkmiljøet - noe som var viktig for dem begge. Heldigvis viste Horten og Falkensten ' +
    'seg som et trygt og fint sted å bo, kanskje spesielt med små barn. Falkensten var et lite område hvor alle kjente alle, med et hyggelig lokalmiljø. ' +
